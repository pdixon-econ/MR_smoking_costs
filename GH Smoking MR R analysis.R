...
##\\rdsfcifs.acrc.bris.ac.uk\MRC-IEU-research\projects\ieu2\p1\013\working\data\Smoking

setwd("//rdsfcifs.acrc.bris.ac.uk/MRC-IEU-research/projects/ieu2/p1/013/working/data/Smoking/Individual genotypes/")
...
dat_mvmr <- read.csv(file = "//rdsfcifs.acrc.bris.ac.uk/MRC-IEU-research/projects/ieu2/p1/013/working/data/Smoking/GWAS summary stats/All SNPs for MVMR/mvmr_analysis_sample1.csv")
...
dat_mvmr <- read.csv(file = "//rdsfcifs.acrc.bris.ac.uk/MRC-IEU-research/projects/ieu2/p1/013/working/data/Smoking/GWAS summary stats/All SNPs for MVMR/mvmr_analysis_sample2.csv")
